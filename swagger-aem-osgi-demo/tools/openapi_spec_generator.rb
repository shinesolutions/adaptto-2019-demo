...
# This tool uses ruby_aem to generate the OpenAPI v3 specification
# for all configuration nodes located at /system/console/configMgr

require 'ruby_aem'

def call_usage
  puts 'openapi_spec_generator.rb Usage:
  ./openapi_spec_generator.rb --in templates/api.yml --out conf/api.yml'
  exit 1
end
